...
const JigsawGame = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-r from-blue-500 to-teal-500">
            ...
            <div className="absolute flex p-2 space-x-4 bg-white rounded-lg shadow-md top-20 left-4">
                <div>
            ...
            <div className="w-full max-w-3xl overflow-hidden bg-white border-4 border-gray-200 rounded-lg shadow-2xl">
                <JigsawPuzzle
                    imageSrc={imageSrc}
                    rows={rows} 
                    columns={columns} 
